...
RULE_DISPLAY_NAMES = {
    ...
    "synthesize-brief": "Synthesize brief",
    "web-search-only": "Web search only",
...
SKILL_DISPLAY_NAMES = {
    ...
    "conduct-research": "Conduct research",
    "aggregate-research-brief": "Aggregate research brief",
...
def assemble_agent_prompt(agent_id: str, *, include_warehouse: bool | None = None) -> str:
    """Build the runtime prompt from the agent meta plus assigned rules and skills."""
    from .agents import is_sub_agent, resolve_agent_definition_id
    ...
    if include_warehouse is None:
        include_warehouse = not is_sub_agent(definition_id)
    try:
