...
def _text_report(language: str, report_type: str) -> str:
    ...
    if language == "fa":
        if level == "high":
            return (
                ...
                "شمال با ۴۲۰ نزدیک شرق است؛ جنوب با ۳۱۰ در میانه قرار دارد.\n"
                "روند فصلی نشان می‌دهد شرق پایدارتر از شمال رشد کرده است.\n"
                "شکاف شرق–غرب حدود ۲۳۰ واحد است و باید در اولویت بررسی باشد.\n"
                "پیشنهاد می‌شود روی نرخ تبدیل غرب تمرکز شود.\n"
                "ظرفیت شرق را حفظ کنید تا رشد پایدار بماند.\n"
                "فیلترهای دوره و واحد اندازه‌گیری را در تصمیم‌گیری لحاظ کنید.\n"
                "(نمونه دمو)"
            )
        if level == "medium":
            return (
                "خلاصه: شرق بیشترین درآمد (۵۱۰) را دارد.\n"
                "غرب کمترین درآمد (۲۸۰) را دارد.\n"
                "شمال و جنوب در میانه (۴۲۰ و ۳۱۰) هستند.\n"
                "اولویت: بهبود غرب و حفظ ظرفیت شرق.\n"
                "(نمونه دمو)"
            )
    ...
    if level == "high":
        return (
            ...
            "North sits near East at 420; South is mid-pack at 310.\n"
            "Seasonal trend favors East over North for sustained growth.\n"
            "The East–West gap is about 230 units and warrants follow-up.\n"
            "Focus next work on West conversion rates.\n"
            "Protect East capacity so growth stays durable.\n"
            "Keep period filters and units in mind when acting on these figures.\n"
            "(Demo sample)"
        )
    if level == "medium":
        return (
            "Summary: East leads revenue at 510.\n"
            "West trails at 280.\n"
            "North and South sit mid-pack at 420 and 310.\n"
            "Prioritize West conversion and East capacity.\n"
            "(Demo sample)"
        )
